...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tt-zhcm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tt-zhcm.containers.anotherwebservice.com/
...
```
git clone git@github.com:jcarrill0/container-tt-zhcm.git
cd container-tt-zhcm
```
...
```
docker attach container-tt-zhcm
```
